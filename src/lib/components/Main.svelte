...
<main class="flex flex-col flex-1 p-4 text-center">
  <section
    id="introPage"
  ...
  >
    ...
    >
      ...
      <p class="text-base sm:text-lg md:text-xl">
        The <span class="text-white-400">best way to reach </span> human instead
        of spam folders. Deliver transactional and marketing emails at scale.
      </p>
  ...
  >
    ...
    <div>
      <div class="relative shadow-2x1 grid place-items-center">
        <img
          ...
          alt="Inbox Logo"
          class="object-cover z-[2] max-h-[30vh]"
        />
      </div>
      <br />
      ...
      <h6 class="text-large sm:text-xl md:text-2xl text-center">
        <br /> A simple, elegant interface so you can start sending emails in
        minutes. It fits
        <br />right into your code with SDKs for your favorite programming
        languages.
      </h6>
    </div>
    ...
    <div>
      ...
      <h6 class="text-large sm:text-xl md:text-2xl">
        <br /> We are a team of engineers who love building tools for other
        engineers.
        <br />Our goal is to create the email platform we've always wished we
  ...
  <section>
    ...
    <div>
      <h6 class="text-small sm:text-xl md:text-2xl text-center">
        <br /> Create beautiful templates without having to deal with table
        layouts and HTML.
    ...
    <div>
      <h6 class="text-small sm:text-xl md:text-2xl text-center">
        ...
        <br />templates. What else could we ask for.<br /><br /><br /><br /><br
        /><br />
      </h6>
    </div>
    <div class="relative shadow-2x1 grid place-items-center">
    ...
    <div>
      ...
      <h6 class="text-small sm:text-xl md:text-2xl text-center">
        <br />All the features you need to manage your email sending,
        troubleshoot with
        <br />detailed logs, and protect your domain reputation – without the
        friction.
      </h6>
    </div>
    <div class="relative shadow-2x1 grid place-items-center">
      <img
        ...
        alt="Inbox Logo"
        class="object-cover z-[2] max-h-[150vh]"
      />
    </div>
    <div>
      <h1 class="font-semibold text-3xl sm:text-4xl text-center">
